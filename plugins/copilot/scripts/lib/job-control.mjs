...
function inferLegacyJobPhase(job, progressPreview = []) {
  ...
  for (let index = progressPreview.length - 1; index >= 0; index -= 1) {
    ...
    if (line.startsWith("starting copilot") || line.startsWith("session ready") || line.startsWith("thread ready") || line.startsWith("turn started")) {
      return "starting";
    }
    ...
    if (line.startsWith("copilot error:") || line.startsWith("session turn") || line.startsWith("failed:")) {
      return "failed";
    }
  }
