...
test("rescue command absorbs continue semantics", () => {
  ...
  assert.match(runtimeSkill, /use the `copilot-prompting` skill to rewrite the user's request into a tighter Copilot prompt/i);
...
test("internal docs use task terminology for rescue runs", () => {
  ...
  const promptRecipes = read("skills/copilot-prompting/references/codex-prompt-recipes.md");
