...
import { createBrokerEndpoint, parseBrokerEndpoint } from "../plugins/copilot/scripts/lib/broker-endpoint.mjs";
...
test("createBrokerEndpoint uses named pipes on Windows", () => {
  ...
  assert.equal(endpoint, "pipe:\\\\.\\pipe\\cxc-12345-copilot-acp");
  assert.deepEqual(parseBrokerEndpoint(endpoint), {
    kind: "pipe",
    path: "\\\\.\\pipe\\cxc-12345-copilot-acp"
  });
});
